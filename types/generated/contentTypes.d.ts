...
export interface ApiAuthLogAuthLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Authentication event logs for security and audit purposes';
  ...
  attributes: {
    ...
    userId: Schema.Attribute.BigInteger & Schema.Attribute.Required;
  };
}
...
export interface ApiAuthTokenAuthToken extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Short-lived, single-use tokens for email verification, password reset, and 2FA challenges';
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['email_verification', 'password_reset', 'twofa_challenge']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course content type for managing educational content';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curriculum: Schema.Attribute.Component<'shared.course-module', true>;
    ...
    status: Schema.Attribute.Enumeration<['Published', 'Draft', 'Archived']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Draft'>;
    stock: Schema.Attribute.Enumeration<
      ['In stock', 'Limited stock', 'Out of stock']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'In stock'>;
    stockQuantity: Schema.Attribute.Integer;
    students: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    tags: Schema.Attribute.JSON;
    targetAudience: Schema.Attribute.JSON;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    totalHours: Schema.Attribute.Decimal;
    type: Schema.Attribute.Enumeration<
      ['Course', 'Book', 'Event', 'Webinar', 'Masterclass', 'Workshop']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    virtual: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Instructor content type for managing course instructors';
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Course review content type for managing user reviews';
    displayName: 'Review';
    pluralName: 'reviews';
    singularName: 'review';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailConfirmedAt: Schema.Attribute.DateTime;
    failedLoginCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    twoFactorEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    twoFactorMethod: Schema.Attribute.Enumeration<['totp', 'email']>;
    twoFactorSecret: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };

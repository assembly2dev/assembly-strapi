/**
 * Direct PostgreSQL insertion script for instructors (simplified)
 * This script directly inserts instructor data into the live PostgreSQL database
 * using only the basic columns that exist in the table
 * Usage: node scripts/direct-postgres-simple-insert.js
 */
...
async function insertInstructorsDirectly() {
  ...
  try {
    ...
    // Insert each instructor using only basic columns
      ...
      try {
        const insertQuery = `
          INSERT INTO instructors (
            ...
            show_on_facilitators_page, created_at, updated_at, published_at

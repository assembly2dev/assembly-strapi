/**
 * Live import script for instructors
 * This script imports instructor data into a running Strapi instance
 * Usage: node scripts/import-instructors-live.js
 */
...
async function importInstructors() {
  console.log('Starting live instructor import...');
  ...
  if (results.length > 0) {
    console.log('\n🎉 Instructors are now available in the database!');
    console.log('You can now fetch them using:');
    console.log('- GET /api/instructors');
    console.log('- GET /api/instructors?populate=*');
    console.log('- GET /api/instructors?filters[specialty][$eq]=Real Estate Economics');
  }

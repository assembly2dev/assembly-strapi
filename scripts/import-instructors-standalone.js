/**
 * Standalone script to import instructor dummy data
 * This script can be run independently to add instructor data
 * Usage: node scripts/import-instructors-standalone.js
 */
...
async function importInstructors() {
  ...
  // This would typically connect to your Strapi instance
  ...
  console.log('Instructor dummy data prepared successfully!');
  console.log('\nTo import this data into your Strapi instance:');
  console.log('1. Start your Strapi server');
  console.log('2. Use the Strapi admin panel or API to create instructors');
  console.log('3. Or use the TypeScript import script with Strapi instance');
